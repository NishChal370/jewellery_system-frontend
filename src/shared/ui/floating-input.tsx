...
function FloatingInput({ label, className, errorMessage, ...props }: FloatingInputProps) {
      return (
            <div className="relative w-full h-fit flex flex-col gap-1.5">
                  <input
                        data-slot="input"
                        className={cn(
                              "peer h-15 w-full rounded-md px-3 pt-4 border border-input flex min-w-0  bg-transparent mt-0 shadow-xs transition-[color,box-shadow] outline-none",
